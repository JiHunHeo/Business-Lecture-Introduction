...
$('.m3 > .m3_skill').mousemove(function () {
    $('.html').animate({ width: '90%' }, { duration: 3000 });
    $('.javascript').animate({ width: '65%' }, { duration: 3000 });
    $('.photoshop').animate({ width: '81%' }, { duration: 3000 });
    $('.figma').animate({ width: '83%' }, { duration: 3000 });
    $('.drive').animate({ width: '65%' }, { duration: 3000 });
});
/* 제작 스토리 */
/* 몬드리안 */
